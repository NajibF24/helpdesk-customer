...
KTUtil.ready(function() {
    ...
    // Init Quick Notifications Offcanvas Panel
    if (typeof KTLayoutQuickNotificationsMessages !== 'undefined') {
        KTLayoutQuickNotificationsMessages.init('kt_quick_notifications_messages');
    }
...
var KTLayoutQuickNotificationsMessages = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_notifications_messages_close',
            toggleBy: 'kt_quick_notifications_messages_toggle'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
	module.exports = KTLayoutQuickNotificationsMessages;
}
