...
<html lang="en">
	<head><base href="">
		<meta charset="utf-8" />
		<title>Employee Portal - PT. Garuda Yamato Steel Tbk.</title>
        ...
        <link rel="apple-touch-icon" href="{{ URL::to('/') }}/grp_bg_logo.png"/>
		...
		#kt_datatable td , #monitoring td {
			white-space: nowrap;
			overflow: hidden;
			height: 10px;
		}
		#kt_datatable th, #monitoring th{
			padding-top: 0.8rem;
		...
		#kt_datatable table, #monitoring table{
			table-layout:fixed;
		}
	...
	>
		...
		<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
			<!--begin::Logo-->
			<a href="{{URL('/')}}">
				<img alt="Logo" src="{{URL('/')}}/grp_bg_logo.png" class="logo-default max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			<div class="d-flex align-items-center">
				<!--begin::Aside Mobile Toggle-->
				<button class="btn p-0 burger-icon burger-icon-left" id="kt_aside_tablet_and_mobile_toggle">
					<span></span>
				</button>
				<!--end::Aside Mobile Toggle-->
				<button class="btn btn-hover-text-primary p-0 ml-3" id="kt_header_mobile_topbar_toggle">
					<span class="svg-icon svg-icon-xl">
						<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/General/User.svg-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left d-flex flex-column flex-row-auto" id="kt_aside" style="">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="background-image: url({{ URL::to('/assets/images/bg_side.jpg') }});height:140vh;overflow-y:unset !important;background-position: center;background-repeat: no-repeat;background-size: cover;">
							<!--begin::Menu Nav-->
							<style>
.flaticon-menu {
	margin-right:10px;
...
.aside-menu .menu-nav > .menu-item .menu-submenu .menu-item :hover {
    background: white !important;
							...
							<ul class="menu-nav">
								<li class="menu-item menu-item-active" aria-haspopup="true">
									<a href="{{URL('/')}}/home" class="menu-link">
										{{-- <span class="flaticon2-protection menu-icon icon-xl text-danger">
										</span> --}}
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/garage.png') }}" style="width: 24px;">
										<span class="menu-text">Home</span>
									</a>
								</li>

								<li class="menu-item" aria-haspopup="true">
									<a href="{{URL('/')}}/request-service/service-catalog/2?division={{@$division->id}}" class="menu-link">
										{{-- <span class="flaticon2-laptop menu-icon icon-xl d-none">
										</span> --}}
										...
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/request_service.png') }}" style="width: 24px;">
										<span class="menu-text">Request Service</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{URL('/')}}/request-incident/incident-catalog/2" class="menu-link">
										{{-- <span class="flaticon2-laptop menu-icon icon-xl d-none">
										</span>
										...
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/request_incident.png') }}" style="width: 24px;">
										<span class="menu-text">Request Incident</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="/report" class="menu-link">
										{{-- <span class="flaticon2-protection menu-icon icon-xl d-none">
										</span>
										<span class="svg-icon  svg-icon-info menu-icon svg-icon-2x">
											<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Chart-pie.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"/>
													<path d="M4.00246329,12.2004927 L13,14 L13,4.06189375 C16.9463116,4.55399184 20,7.92038235 20,12 C20,16.418278 16.418278,20 12,20 C7.64874861,20 4.10886412,16.5261253 4.00246329,12.2004927 Z" fill="#000000" opacity="1"/>
													<path d="M3.0603968,10.0120794 C3.54712466,6.05992157 6.91622084,3 11,3 L11,11.6 L3.0603968,10.0120794 Z" fill="#000000"/>
												</g>
											</svg><!--end::Svg Icon-->
										</span> --}}
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/report.png') }}" style="width: 24px;">
										<span class="menu-text">Report</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{URL('/')}}/approve-request" class="menu-link">
										{{-- <span class="flaticon2-laptop menu-icon icon-xl d-none">
										</span>
										<span class="svg-icon  svg-icon-warning menu-icon svg-icon-2x">
										...
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/approve_request.png') }}" style="width: 24px;">
										<span class="menu-text">Approve Request</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{URL('/')}}/approve-request?type=all" class="menu-link">
										<span class="flaticon2-laptop menu-icon icon-xl d-none">
										</span>
										<span class="svg-icon  svg-icon-warning menu-icon svg-icon-2x">
											<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Clipboard-check.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										<span class="menu-text">All Approve Request</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{URL('/')}}/ticket-monitoring" class="menu-link">
										{{-- <span class="flaticon2-warning menu-icon icon-xl d-none">
										</span>
										<span class="svg-icon  svg-icon-danger menu-icon svg-icon-2x">
										...
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/tracking_your_ticket.png') }}" style="width: 24px;">
										<span class="menu-text">Tracking Your Ticket</span>
									</a>
								</li>

								@php
									$s1 = Request::segment(1);
									$url_inventory_management = in_array($s1, ['inventory_list', 'goods_issue', 'goods_receive', 'inventory_report', 'inventory_transaction_report']);
								@endphp

								<li class="menu-item d-none" aria-haspopup="true">
									<a href="{{URL('/')}}/myDraft" class="menu-link">
										{{-- <span class="flaticon2-warning menu-icon icon-xl d-none">
										</span>
										<span class="svg-icon  svg-icon-info menu-icon svg-icon-2x">
											<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Urgent-mail.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/draft_request.png') }}" style="width: 24px;">
										<span class="menu-text">Draft Request</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{URL('/')}}/faq" class="menu-link">
										...
										<img class="svg-icon flaticon-menu" src="{{ url('/assets/img/icons/faq.png') }}" style="width: 24px;">
										<span class="menu-text">FAQ &amp; Tutorials</span>
									</a>
								</li>
							</ul>
							<!--end::Menu Nav-->
			...
			<button class="btn btn-icon aside-toggle ml-n3 mr-8" id="kt_aside_desktop_toggle">
				<span class="flaticon2-soft-icons icon-xl text-dark-75" style="color: #fff !important;/*#827170*/">
				</span>
			</button>
								<!--begin::Logo-->
								<a href="{{URL('/')}}">
                                    <img src="{{ URL::to('/').'/grp_bg_logo.png' }}" alt="" id="Layer_1" height="70px;">
								</a>
								<!--end::Logo-->
								<div class="d-none navi-item my-2">
									<a href="#" class="navi-link active">
										...
										<span class="navi-text font-weight-bolder font-size-lg">Submit Ticket</span>
								...
								<div class="d-none navi-item my-2">
									<a href="#" class="navi-link active">
										...
										<span class="navi-text font-weight-bolder font-size-lg">Closed Ticket</span>
										<span class="navi-label">
											<span class="label label-rounded label-light-success font-weight-bolder">3</span>
										</span>
									</a>
								...
								<div class="d-none quick-search quick-search-inline ml-10 w-350px" id="kt_quick_search_inline">
									<!--begin::Form-->
									{!! Form::open(['route' => ['search.store']]) !!}
										<div class="input-group rounded bg-light">
											...
											<input type="hidden" name="route" class="form-control h-45px" placeholder="Search..." value="{{app('request')->path()}}" />
							...
							<div class="topbar">
								...
								<!-- <form action="{{ route('search.store') }}" class="search-form mt-7 mr-6" method="POST"> -->
								{!! Form::open(['route' => ['search.store'], 'class' => 'search-form mt-7 mr-6']) !!}
									<div class="form-group has-feedback show-mobile">
    ...
    margin-top: -37px;
								...
								<div class="dropdown d-none">
									...
									<div class="topbar-item mr-4" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-light-danger font-weight-bold px-5"> <i class="flaticon2-open-box"></i> Create</div>
									</div>
									<!--end::Toggle-->
									<!--begin::Dropdown-->
								...
								<!--end::Create-->
								<!--begin::Quick Panel-->
								<div class="topbar-item mr-4" hidden>
									<div class="btn btn-icon btn-sm btn-clean btn-text-dark-75" data-toggle="tooltip" title="Create">
										<span class="flaticon2-add text-danger icon-lg">
										</span>
									</div>
								</div>
								<!--begin::Quick Panel-->
								<div class="topbar-item mr-4 d-none">
									<div class="btn btn-icon btn-sm btn-text-danger btn-dropdown" id="kt_quick_panel_toggle" data-toggle="tooltip" title="Quick Panel">
										<span class="flaticon2-open-box text-danger icon-lg">
										</span>
									</div>
								</div>
								<!--end::Quick Actions-->
								<!--begin::Quick Actions-->
								<div class="topbar-item mr-4"  data-toggle="dropdown" data-offset="10px,0px"  data-toggle="tooltip" title="User Messages">
									<?php
										$count_unread = DB::table('notification_message')->where('type','=','ticket_comment')->where('user_id',Auth::user()->id)->whereNull('read_at')->count();
									?>
									<div class="btn btn-icon btn-sm" id="kt_quick_notifications_messages_toggle" data-toggle="tooltip" title="User Message">
										<img src="{{ url('/assets/img/icons/comments.png') }}" style="width: 27px;">
									</div>
									@if ($count_unread)
									<span class="label label-sm label-light-danger label-rounded font-weight-bolder" style="margin-top: -25px;padding-left: 0;margin-left: -10px;">{{$count_unread ?? ""}}</span>
									@endif
								</div>
								<!--end::Quick panel-->
								<?php
								...
								<div class="topbar-item mr-4">
									<div class="btn btn-icon btn-sm" id="kt_quick_notifications_toggle" data-toggle="tooltip" title="Notification">
										@if ($count_unread)
										<span class="label label-sm label-light-danger label-rounded font-weight-bolder position-absolute top-0 mt-6 ml-4">{{ $count_unread ?? "" }}</span>
										@endif
										<img src="{{ url('/assets/img/icons/bell.png') }}" style="width: 27px;">
									</div>
								</div>
								<!--end::User-->
								<!--begin::Notifications-->
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle" >
										<div class="symbol symbol-40 symbol-circle" data-toggle="tooltip">
											<?php
											$ct = DB::table('contact')->where('id',Auth::user()->person)->first();
											?>
											@if(!empty($ct->picture))
											<img alt="Pic" src="{{ env("GRP_HELPDESK_URL") }}/uploads/{{$ct->picture}}">
											@else
											<img alt="Pic" src="{{URL('/')}}/template1/src/media/users/default.jpg">
											@endif
										</div>

										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3 ml-2">{{Auth::user()->name}}</span>
<!--
...
-->
						...
						<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center mr-1">
								...
								<div class="d-flex align-items-baseline flex-wrap mr-5">
									<!--begin::Page Title-->
									<h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">{{isset($title)?$title:""}}</h2>
									<!--end::Page Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
										...
										@endif
										<!-- looping untuk breadcumb -->
										@if (isset($breadcumb))
											@foreach ($breadcumb as $key => $bread)
												<li class="breadcrumb-item">
													<a href="{{URL('/')}}/{{$bread['url'] ?? '#'}}" class="text-muted">{{ $bread['name'] ?? $bread }}</a>
												</li>
											@endforeach
										@endif
									</ul>
		...
		<div id="kt_quick_notifications" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between mb-10">
				...
				<small class="text-muted font-size-sm ml-2">{{$count_unread ?? "0"}} New</small></h3>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="navi navi-icon-circle navi-spacer-x-0">
					<?php
					$notifs = DB::table('notification_message')->where('type','!=','ticket_comment')->whereNull('read_at')->where('user_id',Auth::user()->id)->orderBy('created_at','desc')->limit(5)->get();
					$i = 0;
					...
					?>
					<!--begin::Item-->
					<a href="{{URL('/')}}/view_notif/{{$n->token}}" class="navi-item">
						<div class="navi-link rounded">
							<div class="symbol symbol-50 symbol-circle mr-3">
								<div class="symbol-label">
									@if(empty($n->read_at))
									<i class="flaticon-bell text-{{$color3[$i%4]}} icon-lg"></i>
									@else
									<i class="flaticon-bell text-default icon-lg"></i>
									@endif
								</div>
							</div>
							<div class="navi-text">

								<div class="font-weight-bold font-size-lg" style="{{$set}} ">{{strip_tags($n->title)}}</div>
								<div class="text-muted">{{ date('d M Y', strtotime($n->created_at)) }}</div>
							</div>
						</div>
					</a>
					<!--end::Item-->
		...
		<!-- begin::Notifications Panel-->
		<div id="kt_quick_notifications_messages" class="offcanvas offcanvas-right p-10">
			<!--begin::Header-->
			<div class="offcanvas-header d-flex align-items-center justify-content-between mb-10">
				<h3 class="font-weight-bold m-0">User Messages
				<?php
				$count_unread = DB::table('notification_message')->where('type','=','ticket_comment')->where('user_id',Auth::user()->id)->whereNull('read_at')->count();
				?>
				<small class="text-muted font-size-sm ml-2">{{$count_unread ?? "0"}} New</small></h3>
				<a href="#" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_notifications_messages_close">
					<i class="ki ki-close icon-xs text-muted"></i>
				</a>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<!--begin::Action-->
				<div class="d-flex flex-center">
					<a href="/messages" class="btn btn-light-primary font-weight-bold text-center">See All</a>
				</div>
			</div>
			<!--end::Content-->
		</div>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				<div class="row gutter-b">
					...
					<div class="col-6">
						<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Shopping/Euro.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
					...
					<div class="col-6">
						<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Communication/Mail-attachment.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
				...
				<div class="row gutter-b">
					...
					<div class="col-6">
						<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Shopping/Box2.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
					...
					<div class="col-6">
						<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Communication/Group.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<polygon points="0 0 24 0 24 24 0 24" />
				...
				<div class="row gutter-b">
					...
					<div class="col-6">
						<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Shopping/Chart-bar1.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
					...
					<div class="col-6">
						<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							<span class="svg-icon svg-icon-3x svg-icon-primary m-0">
								<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Design/Color-profile.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol mr-5" style="width:100px;height:auto;">
						@if(!empty($ct->picture))
						<div class="symbol-label" style="width:100px;height:auto;overflow:hidden">
							<img src="{{env('GRP_HELPDESK_URL')}}/uploads/{{$ct->picture}}" style="width:100px;"/>
						</div>
						@else
						<div class="symbol-label" style="width:100px;height:auto;min-height:100px;overflow:hidden;background-image:url('{{URL('/')}}/template1/src/media/users/default.jpg')"></div>
						@endif
								...
								<span class="navi-link p-0 pb-2">
									<span class="navi-icon mr-1">
										<span class="svg-icon svg-icon-lg svg-icon-primary">
											<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Communication/Mail-notification.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					?>
					@if ($url_profile == 0)
					<a href="javascript:;" class="navi-item d-none">
					@else
					<a href="{{URL('/')}}/edit/{{Auth::user()->person}}/profile" class="navi-item d-none">
					@endif
						<div class="navi-link">
					...
					<a href="{{URL('/')}}/change_password" class="navi-item">

						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<span class="svg-icon svg-icon-md svg-icon-danger">
										<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Code\Lock-overturning.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24"/>
							...
							<div class="navi-text">
								...
								<div class="text-muted">Secure Your Account</div>
							</div>
						</div>
					</a>

					<?php
					$is_super_admin = DB::table('lnkuserstoroles')->where('users_id',Auth::user()->id)->where('roles_id',4)->first();
					$is_agent = DB::table('contact')->where('id',Auth::user()->person)->value('is_agent');

					if($is_super_admin || $is_agent) {
					?>
					<a target="_blank" href="{{URL('/')}}/openApps/ngs_portal" class="navi-item">
						...
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Helpdesk Portal</div>
								<div class="text-muted">Open portal for Agent</div>
							</div>
						</div>
					</a>
						...
						<div class="mb-5">
							...
							<div class="d-flex align-items-center bg-light-success rounded p-5 mb-5">
								<span class="svg-icon svg-icon-success mr-5">
									<span class="svg-icon svg-icon-lg">
										<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Communication/Write.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
							...
							<div class="d-flex align-items-center bg-light-danger rounded p-5 mb-5">
								<span class="svg-icon svg-icon-danger mr-5">
									<span class="svg-icon svg-icon-lg">
										<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Communication/Group-chat.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
							...
							<div class="d-flex align-items-center bg-light-info rounded p-5">
								<span class="svg-icon svg-icon-info mr-5">
									<span class="svg-icon svg-icon-lg">
										<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/General/Attachment2.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
							...
							<div class="text-left flex-grow-1">
								...
								<div class="dropdown dropdown-inline">
									<button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										<span class="svg-icon svg-icon-lg">
											<!--begin::Svg Icon | path:{{URL('/')}}/assets/media/svg/icons/Communication/Add-user.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
		...
		<!--end::Page Scripts-->
		<script src="{{URL('/')}}/assets/js/pages/crud/forms/editors/bootstrap-markdown.js"></script>
		<script src="{{URL('/')}}/assets/plugins/custom/datatables/datatables.bundle.js"></script>
		<script src="{{URL('/')}}/assets/js/pages/crud/datatables/advanced/multiple-controls.js"></script>
		<script src="{{URL('/')}}/template1/src/js/pages/crud/forms/widgets/bootstrap-daterangepicker.js"></script>
		<script src="{{URL('/')}}/template1/src/js/pages/crud/forms/widgets/select2.js"></script>
...
-->
		<div id="loading-spinner" style="display: none;">
			<img src="{{  URL::to('/assets/images/loading.gif') }}" class="w-50" alt="Loading..." />
		</div>
		<script>
