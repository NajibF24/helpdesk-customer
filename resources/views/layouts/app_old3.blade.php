...
<html lang="en">
	...
	>
		...
		<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
			<!--begin::Logo-->
			<a href="{{URL('/')}}">
				<img alt="Logo" src="{{URL('/')}}/assets/images/logo_nabati.png" class="logo-default max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
    ...
    padding: 15px 25px;
							...
							<ul class="menu-nav">
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="{{URL('/')}}/request-service/service-catalog/2" class="menu-link">
			...
			<button class="btn btn-icon aside-toggle ml-n3 mr-8" id="kt_aside_desktop_toggle">
				<span class="flaticon2-soft-icons icon-xl text-dark-75" style="color: #fff !important;/*#827170*/">
								...
								<!--begin::Logo-->
								<a href="{{URL('/')}}">
									<img alt="Logo" src="{{URL('/')}}/assets/images/logo_nabati.png" class="logo-sticky max-h-42px" style="height: 40px;" />
							...
							<div class="topbar">
								...
								<form action="{{URL('/')}}/search" class="search-form mt-7 mr-6" >
...
.search-form .form-group span.form-control-feedback {
    ...
    margin-top: -37px;
								...
								<!--begin::Quick Actions-->
								<div class="topbar-item mr-4">
									<div class="btn btn-icon btn-sm btn-clean btn-text-dark-75" id="kt_quick_actions_toggle22" data-toggle="tooltip" title="Quick Action">
										<span class="flaticon2-writing text-danger icon-lg">
										</span>
									</div>
								</div>
								<!--end::Quick panel-->
								<!--begin::User-->
								<div class="topbar-item mr-4">
									<div class="btn btn-icon btn-sm btn-clean btn-text-dark-75" id="kt_quick_notifications_toggle" data-toggle="tooltip" title="Notification">
										<span class="flaticon2-bell-1 text-danger icon-lg">
										</span>
									</div>
								</div>
								<!--end::User-->
									...
									<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
										...
										@if (isset($breadcumb))
											@foreach ($breadcumb as $key => $bread)
												<li class="breadcrumb-item">
													<a href="#" class="text-muted">{{ $bread }}</a>
												</li>
											@endforeach
										@endif
									</ul>
		...
		<div id="kt_quick_notifications" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="navi navi-icon-circle navi-spacer-x-0">
					<?php
					$notifs = DB::table('notification_message')->where('user_id',Auth::user()->id)->orderBy('created_at','desc')->limit(50)->get();
					$i = 0;
					...
					?>
					<!--begin::Item-->
					<a href="{{URL('/')}}/view_notif/{{$n->id}}" class="navi-item">
