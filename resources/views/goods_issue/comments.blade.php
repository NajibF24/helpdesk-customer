<style>
    ...
    <?php 
    $comments = DB::table('inventory_comments')->orderBy('id','desc')->where($type.'_id',$detail->id)->get();
                    ...
                    <div class="d-flex">					
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-between">
                                <!--begin::Description-->
                                <div class="flex-grow-1 font-weight-bold text-dark-50 py-2 py-lg-2 mr-5" style="overflow-wrap: break-word; word-break:break-all;">
                                    <?=$c->message?>
                                </div>
                                <!--end::Description-->
                            </div>
                        ...
                        <div class="justify-content-end mr-2">
                            ...
                            {{-- <button class="btn btn-sm btn-white-line2 delete-comment" data-id="{{$c->id}}"><i class="fa fa-icon fa-trash"></i>&nbsp;Delete</button> --}}
                        </div>
                    </div>
                    <!--end::Top-->
            ...
            <div class="d-flex flex-column mb-5 align-items-end">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <a href="javascript:void(0)" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6" style="display:block">You</a>
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                ...
                                <div class="mr-3">
                                    ...
                                    @endif
                                    <!--begin::Name-->
                                    <a href="javascript:void(0)" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{$contact->name ?? ""}}
