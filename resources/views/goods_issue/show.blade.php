...
<div class="container-fluid">
    ...
    <div class="row d-flex">
        <div class="col-xl-8">
			@include('goods_issue.content_left')
        </div>
        <div class="col-xl-4 mt-8 mt-md-0">
            ...
            <div class="card card-custom gutter-b h-full">
                <div class="card-header align-items-center border-0 mt-4">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="font-weight-bolder text-dark">Goods Issue Status</span>
                    </h3>
                </div>
			...
			@include('goods_issue.case_journey_content')

        </div>

        <div class="col-12 mt-8">
			@include('goods_issue.material_list')
            <div class="messages">
			    @include('goods_issue.comments', ['type' => 'goods_issue'])
            </div>
        </div>
    </div>
    <!--end::Row-->
