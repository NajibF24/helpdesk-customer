...
<script src="{{URL('/')}}/assets/excel-lib/formula-parser.js"></script>
<script src="{{URL('/')}}/assets/excel-lib/clipboard.js"></script>
<script src="{{URL('/')}}/assets/excel-lib/spreadsheet.js"></script>
...
<script>
	...
	fields.push({
		...
		icon: '<i  class="far fa-file-excel" style="    color: #5f636f;"></i>'
	})
    ...
    let templates = {
		...
		excel_table: function(fieldData) {
			return {
				field: `
				<div class="excel-formulator-wrapper">
					<div class="container">
						<div class="formula-bar">
							<div class="formula-bar-content mb-3">
								<div class="formula-input-container">
									<label>Columns:</label>
									<input type="number" id="colsInput" class="formula-input" value="6" placeholder="Enter number of columns">
								</div>
								<div class="formula-input-container">
									<label>Rows:</label>
									<input type="number" id="rowsInput" class="formula-input" value="10" placeholder="Enter number of rows">
								</div>
							</div>
							<div class="formula-bar-content">
								...
								<div class="formula-input-container">
									<label>Formula:</label>
									<input type="text" id="formulaInput" class="formula-input" placeholder="Enter value or formula (e.g., =A1+B1, =SUM(A1:A5))">
								</div>
							</div>
						</div>
...
$('#form_submit').on('submit',(function(e) {
	...
	formData.append('excel_data', JSON.stringify(window.spreadsheetAPI.getDataAsArray()))
...
$('.btn-submit').click(function() {
	...
	$(document).ready(function() {
		$('#rowsInput, #colsInput').on('input', function() {
			let rows = parseInt($('#rowsInput').val()) || 10;
			let cols = parseInt($('#colsInput').val()) || 6;
