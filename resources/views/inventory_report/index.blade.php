...
<div class="container-fluid">
    ...
    <div class="m-5 table-responsive" style="">
        @include('flash::message')
...
$(document).ready( function () {
    ...
    $('#apply-filter').click(function() {
        ...
        initDatatable(`?status=${status}&material_group=${materialGroup}&material_code=${materialCode}&warehouse=${warehouse}`);
    })
    ...
    $('#export').click(function() {
        ...
        window.location.href = `{{route('inventory_report.export')}}?status=${status}&material_group=${materialGroup}&material_code=${materialCode}&warehouse=${warehouse}`
    })
 });
...
function initDatatable(filters = '') {
    $('#main-table').DataTable({
        ...
        serverSide: true,
        bDestroy: true,
        ajax: "{{ route('inventory_report.index') }}"+filters,
        columns: [
            { data: 'id', name: 'id' },
            ...
            { data: 'qty', name: 'qty' },
            { data: 'inventory_type.label', name: 'inventory_type.label', defaultContent: '' },
            ...
            { data: 'material_tag', name: 'material_tag' },
