...
<head>
    ...
    <title>Nabati Global Service Management System</title>
...
-->
    ...
    <link rel="stylesheet" href="{{URL('/')}}/vendor/bootstrap/dist/css/bootstrap.min.css" crossorigin="anonymous"/>
...
<div class="container-fluid">
    ...
    overflow: hidden;border:0px solid #2abfcc;margin:0 -12px 0 -15px;display:block;padding-left:0px;padding-right:0px;">
	<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="height:100%;width:100%;"> 
				  ...
				  <div class="carousel-inner" style="height:100%;">
					<div class="carousel-item active" style="height:100%;" data-bs-interval="4000">
					  {{-- <div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/_slide1.jpg')"></div> --}}
					  <div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/slide1.png')"></div>
					</div>
					<div class="carousel-item" style="height:100%;" data-bs-interval="4000">
					  {{-- <div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/_slide2.jpg')"></div> --}}
					  <div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/slide2.png')"></div>
					</div>
					<div class="carousel-item" style="height:100%;" data-bs-interval="4000">
						{{-- <div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/_slide3.jpg')"></div> --}}
						<div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/slide3.png')"></div>
					</div>
					<div class="carousel-item" style="height:100%;" data-bs-interval="4000">
						{{-- <div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/_slide4.jpg')"></div> --}}
						<div class="img-slide" style="background-image:url('{{URL('/')}}/assets/images/slide4.png')"></div>
					</div>
				  </div>

				</div>	
				{{-- <img src="{{URL('/')}}/assets/images/login_left.png" style="display:none;width:550px;max-width:80%;margin:auto;overflow-y:auto"/> --}}
			</div>
			<div style="display:block;height:22vh;width:100%;padding-left:20px;padding-right:20px;">
				<div style="display:block;height:22vh;width:100%;margin-top:0px;
							background-image:url('{{URL('/')}}/assets/images/bottom_logo.jpg');
							background-size: contain;background-position: center;background-repeat: no-repeat;"></div>
			</div>
		</div>
		<div class="col-md-3 col-sm-12" style="background:#2abfcc;height:100vh;overflow-y:auto">
					...
					<div class="box-input-login">
						<div style="display: block;
							...
							<img style="display: inline-block;
										...
										max-width: 100px;
										width: 27%;
										position: absolute;" src="{{URL('/')}}/assets/images/logo.png" alt="Nabati Logo" title="Nabati Logo" /> 
							<div style="font-family: 'Uchen';
										font-size: 35px;
										width: 68%;
										display: inline-block;
										color: #e6f3ff;
										text-align: center;
										margin-left: 25%;">NGS</div>
							<div style="font-family: 'Open Sans', sans-serif;
										width: 68%;
										display: inline-block;
										color: #e6f3ff;
										text-align: center;
										margin-left: 25%;">Nabati Global Service</div>
						</div>
						
						
						<form id="form-login" method="post" action="{{ url('/login') }}" style="    width: 470px;
    max-width: 100%;
    display: block;
    margin: auto;
    padding-top: 20px;">
							...
							@enderror
							@if(Session::has('message_expire'))
								<span class="error invalid-feedback">{{ Session::get('message_expire') }}</span>
							@endif
							...
							<div class="input-group mb-4">
								<input type="text"
									   ...
									   required
									   class="input-login form-control @error('username') is-invalid @enderror"
							...
							<div class="input-group mb-2">
								<input type="password"
									   ...
									   required
									   class="input-login form-control @error('password') is-invalid @enderror"
									   style="font-size:14px">
								<div class="input-group-append">
							...
							<div class="row">
								<div class="col-12">
									<a style="text-decoration: none;color: #fff;
											float: right;
											font-size: 14px;margin-top:16px" class="pull-right" href="{{ route('password.request') }}" >Forgot password?</a>
								</div>
								<br/>
								...
								<div class="col-12" style="padding: 0 5px;margin-top:30px">
									<button type="submit" class="btn btn-danger btn-block" style="height: 40px;font-size:15px;float:right;width:100%;background-color:#e84f47;">LOG IN</button>
								</div>
...
<script>
$('#aaaform-login').submit(function() {
  event.preventDefault(); //this will prevent the default submit

  $('#exampleModalCenter').modal('show')
});
$('.btn-helpdesk').click(function() {
  $("#direct-login").val('helpdesk');
  $('#form-login').trigger('submit');
});
$('.btn-employee').click(function() {
	$("#direct-login").val('employee');
  $('#form-login').trigger('submit');
});
