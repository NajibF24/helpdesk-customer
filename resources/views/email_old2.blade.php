...
<title style="margin: 0;padding: 0;font-family: &quot;Helvetica Neue&quot;, &quot;Helvetica&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;font-size: 14px;">{{ $title }}</title>
...
<div class="container mt-5 mb-5">
    <div class="row d-flex justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="lower bg-primary p-4 py-3 text-white d-flex justify-content-between">
                    
                    <h5 style="text-align:center;width:100%">{{$title}}</h5>
                </div>
                <div class="upper p-4">
					<div>
						<?=$ticket->message?>
                    ...
                    <h6 style="font-size: 19px;
								font-weight: 600;
								color: #0d6efd;">Ticket Details</h6>
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-row align-items-center">
                            <div class="add"> <span class="font-weight-bold d-block">{{$rtype}}</span> 
                            <span class=" d-block">
                            <?php
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-row align-items-center">
                            <div class="add"> <span class="font-weight-bold d-block">Subject Request </span> 
                            <span class=" d-block">{{ $ticket->title }}</span> <small></small> </div> 
<!--
...
-->
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-row align-items-center">
                            <div class="add"> <span class="font-weight-bold d-block">Ticket Number </span> 
                            <span class=" d-block">{{ $ticket->ref }}</span> <small></small> </div> 
<!--
                            <img src="" width="60" class="d-none rounded-circle">
-->
                        </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex flex-row align-items-center">
                            <div class="add"> <span class="font-weight-bold d-block">Description</span> 
                            <span class=" d-block"></span> <small></small> </div> 
                        </div>
                    </div>
                    Hi, team <br/><br/>
					<?= $ticket->description ?>	
                    ...
                    <div class="delivery mb-2">
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="ml-0">Ticket Status</span> </div>
                            <span class="font-weight-bold" style="text-align:right">{{ $ticket->status}}</span>
                        </div>
                    </div>
                    <div class="delivery mb-2">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center"> <i class="fa fa-check-circle-o"></i> 
                            <span class="ml-0">Next Approver </span> </div>
                    ...
                    <div class="delivery mb-2">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center"> <i class="fa fa-check-circle-o"></i> 
                            <span class="ml-0">Assignment Tier / Agent </span> </div>
                            <span class="font-weight-bold" style="text-align:right">
                    ...
                    <div class="delivery mb-2">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center"> <i class="fa fa-check-circle-o"></i> 
                            <span class="ml-0">Assign Time</span> </div>
                            <span class="font-weight-bold" style="text-align:right">{{ empty($ticket->assign_time) ? "-" : date('M d, Y h:i A', strtotime($ticket->assign_time))}}</span>
                        </div>
                    </div> 
                    <div class="delivery mb-2">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center"> <i class="fa fa-check-circle-o"></i> 
                            <span class="ml-0">Due Date</span> </div>
                            <span class="font-weight-bold" style="text-align:right">{{ empty($ticket->due_date) ? "-" : date('M d, Y h:i A', strtotime($ticket->due_date))}}</span>
                        </div>
                    </div> 
                    <div class="delivery mb-2">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center"> <i class="fa fa-check-circle-o"></i> 
                            <span class="ml-0">{{$rtype}}</span> </div>
                            <span class="font-weight-bold" style="text-align:right">
							<?php
									$service = DB::table('service')->where('id', $ticket->service_id)->first();
								?>{{ $service->name }}
...
-->
                ...
                <div class="lower bg-primary p-4 py-5 text-white d-flex justify-content-between">
                    <div class="d-flex flex-column"> <span>PT. Kaldu Sari Nabati </span> <small>Copyright 2021 All Right Reserved</small> </div>
                    <h5>Nabati Logo</h5>
                </div>
            </div>
        </div>
